...
from .SPLoadDiffusionModel import SPLoadDiffusionModel
...
NODE_CLASS_MAPPINGS = {
    ...
    "siping_SPLoadDiffusionModel": SPLoadDiffusionModel,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "siping_SPLoadDiffusionModel": "SP Load Diffusion Model (带过滤)",
}
